...
$(document).ready(function () {
  ...
  $('.btn-play').on('click', function () {
    var slideScreen = $(this).siblings('.slide_screen');
    var link = slideScreen.attr('data-video');
    slideScreen.append("\n      <iframe width=\"100%\" height=\"100%\" src=\"".concat(link, "\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" referrerpolicy=\"strict-origin-when-cross-origin\" allowfullscreen></iframe>\n    "));
...
function _initMap() {
  _initMap = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _yield$google$maps$im, Map, _yield$google$maps$im2, AdvancedMarkerElement, markers;
